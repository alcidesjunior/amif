...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { graduacao: @professor.graduacao, modalidade: @professor.modalidade, nome: @professor.nome, sobrenome: @professor.sobrenome } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { graduacao: @professor.graduacao, modalidade: @professor.modalidade, nome: @professor.nome, sobrenome: @professor.sobrenome } }
